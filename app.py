"""
Flask App — Sistem Laporan PKL  v2.1 (fixed)
...
# FIX: 20 MB cukup. Base64 dari 5 MB file ≈ 6.7 MB di JSON.
...
def generate():
    ...
    Mode 1: application/json  → data form (gambar dalam base64 di JSON)
    Mode 2: multipart/form-data → data form + file gambar cover fisik
    """
...
if __name__ == '__main__':
    print("=" * 50)
    print("  Sistem Laporan PKL — Barrr Creative  v2.1")
